              ...
              <div className="banner-border">
                <div>
                  <ul className="banner_list">
                    <li className="act banner-li1"><a href="#" /></li>
                    <li className="banner-li2"><a href="#" /></li>
                    <li className="banner-li3"><a href="#" /></li>
                    <li className="banner-li4"><a href="#" /></li>
                  </ul>
                </div>
                <ol className="lb">
