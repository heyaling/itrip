            ...
            <div className="i_grade_list">
              <div className="card-container">
                ...
                <Tabs type="card" onTabClick={this.recommendClick.bind(this)} >
                  ...
                  <TabPane tab={"有待改善（"+this.state.comment.improve+"）"} key="3">Content of Tab Pane 3</TabPane>
                  <TabPane tab={"有图片("+this.state.comment.havingimg+"）"} key="4">Content of Tab Pane 4</TabPane>
                </Tabs>
              </div>
            </div>
          </div>
